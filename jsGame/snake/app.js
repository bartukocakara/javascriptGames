document.addEventListener('DOMContentLoaded', () => {
    ...
    let appleIndex = 0 //also first div in our grid
    let currentSnake = [2, 1, 0] //so the div in our grid being 2 (or the head), and  0 being the end (TAIL, with all 1's
    ...
    function randomApple(){
        do{
            ...
            (squares[appleIndex].classList.contains('snake')) // making sure apple is eaten
    ...
    function control(e) {
        ...
        if(e.keyCode === 39){
            ...
            direction = -width //if we press up arrow, the snake will go back
        }
